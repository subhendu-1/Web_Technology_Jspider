...
let taskEle = document.getElementById('task-ele');
    ...
    if(list.length > 0){
        ...
        list.forEach((task,i)=>
        {
            eachTask += `<li class="List-group-item List-group-item-secondary mb-3">
                        <span class="fw-bold">Do Party</span>
                        <button class="float-end ms-3">
        ...
        document.getElementById('task-list-ele').innerHTML = eachTask;
    }
}
